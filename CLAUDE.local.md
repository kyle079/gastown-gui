...
**YOU ARE IN: `gastown_gui/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/gastown_gui/` (rig root) or other directories
...
**Your mail address:** `gastown_gui/polecats/chrome`
**Your rig:** gastown_gui
**Your Witness:** `gastown_gui/witness`
...
| Ask Witness for help | `gt mail send gastown_gui/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`gastown_gui/witness`) when:
...
```bash
gt mail send gastown_gui/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
